	...
	<div id="movieList">
		...
		<div id = "searchTool">
			<form 
				id="searchForm" 
				name="searchForm" 
				action="<%=contextPath %>/jiutopia/videoListView.do" 
				method="get" 
			...
			<% if (loginId.equals("mem01")) { %>
				<a id="postingBtn" href="<%=contextPath%>/jiutopia/videoPosting.do">
					<div class="w3-btn w3-brown w3-round-xxlarge" style="display:inline-block;">등록</div>
				</a>
			<% } %>
		</div>		
